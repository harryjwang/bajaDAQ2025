...
#include <sd_diskio.h>
  ...
  */
  ...
  bool setup_statement_printed = false;
  ...
  void IRAM_ATTR isr(){
    ...
    /* Functions */
  void checkMessage(bool acquiringData) {
  ...
  void loop() {
    ...
    if (acquiringData){
      if (dataFile) {
        ...
        dataFile.print(seconds_counter);
        dataFile.print('\t');
        dataFile.print(-(a.acceleration.x - 0.1));
        dataFile.print('\t');
        dataFile.print(-(a.acceleration.y + 0.15));
        dataFile.print('\t');
    ...
    if (acquiringData){
      ...
      Serial.print("      ->      X: ");
      Serial.print(-(a.acceleration.x - 0.1));
      Serial.print(", Y: ");
      Serial.print(-(a.acceleration.y + 0.15));
      Serial.print(", Z: ");
